elias = [
    ...
    'basado en que',
    '33 1749 2461',
    'Broo, 3 de noviembre caemos en rivera repipi',
    'Ahora toca ser Punpun',
    'Me dan miedo los ingenieros',
    'No me gusta la gente que se cree superior',
    'Yo no tengo enemigos',
    'Yo solo tengo dos enemigos',
    'Ahora si tengo enemigos',
    'Ice cube diría to Day is a good Day\nPero yo digo\nTo Day isnt',
    'Encontré donde vive el Internet',
    'Tortigas marinas',
